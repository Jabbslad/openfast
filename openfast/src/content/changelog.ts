...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: "2026-04-05",
    changes: [
      "Protocol picker on the Timer idle screen — tap to switch between all 7 fasting protocols before starting, with selected protocol highlighted and fasting/eating window description shown",
    ],
  },
  {
    version: "0.4.7",
    date: "2026-04-05",
    changes: [
      "PWA icon now fills edge-to-edge so the app colour extends to the border on iOS and Android home screens",
    ],
  },
  {
    version: "0.4.6",
    date: "2026-04-05",
    changes: [
      "A red and white striped drinking straw drops into the glass with a bounce animation when you reach your daily water goal",
    ],
  },
  {
    version: "0.4.5",
